...
class StartupListAPITest(APITestCase):
    ...
    def setUpTestData(cls):
        cls.user1 = User.objects.create_user(
            username="teststartup1", email="startup1@test.com", password="password123"
        )
        cls.user2 = User.objects.create_user(
            username="teststartup2", email="startup2@test.com", password="password123"
        )
    ...
    def test_regions_are_correctly_serialized(self):
        ...
        handmade = next(
            s for s in response.data["results"] if s["company_name"] == "Handmade Co"
        )
    ...
    def test_tags_are_aggregated_from_projects(self):
        ...
        self.assertCountEqual(handmade["tags"], ["craft", "pottery"])
