...
from .serializers import StartupListSerializer, StartupPublicSerializer


# Create your views here.
class StartupPublicDetailView(RetrieveAPIView):
    queryset = StartupProfile.objects.prefetch_related("projects__tags")
