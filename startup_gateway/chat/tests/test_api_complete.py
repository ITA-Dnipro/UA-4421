...
class ConversationCreateAPITest(TestCase):
    ...
    def test_create_conversation_success(self):
        ...
        data = {'participants': [self.investor.id, self.startup.id]}
    ...
    def test_create_conversation_with_project(self):
        ...
        data = {
            'participants': [self.investor.id, self.startup.id],
    ...
    def test_create_conversation_forbidden_for_startup(self):
...
class MessageCreateAPITest(TestCase):
    ...
    def test_send_message_success(self):
        ...
        data = {'body': 'Test message via REST API'}
