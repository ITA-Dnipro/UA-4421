...
class TestModels(TestCase):
    ...
    def test_userroles(self):
        self.assertTrue(UserRole.objects.filter(user=self.startup_user, role__name='startup').exists())
        self.assertTrue(UserRole.objects.filter(user=self.investor_user, role__name='investor').exists())
